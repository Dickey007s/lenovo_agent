        ...
        units=[
            *roots,
            HarnessPlanUnit(
                ...
                input_file_refs=[roots[0].input_file_refs[0], roots[2].input_file_refs[0]],
                depends_on=["product-gate", "ux-evidence"],
                tool="file.read",
            ),
            HarnessPlanUnit(
                ...
                input_file_refs=[roots[1].input_file_refs[0]],
                depends_on=["search-risk"],
                tool="file.read",
            ),
        ],
    )
