...
- `exports/Office-Agent-技术差异与交互影响-20260830-24页版-v2.pptx`：可编辑 PowerPoint，含 24 页中文演讲备注。
- `OFFICE-AGENT-TECH-INTERACTION-CHINESE-SPEAKER-SCRIPT-20260829.md`：对应 24 页的 40 至 45 分钟完整中文讲稿，含转场和常见追问口径。
