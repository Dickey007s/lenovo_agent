...
9. FORTE、数据预览、只读分析与统一 Harness 变更再读 `docs/decisions/DR-0016-public-workspace-agent-harness.md`、`DR-0017-single-forte-worksite-and-legacy-retirement.md`、`DR-0018-forte-data-workbench-and-verifiable-trace.md`、`docs/scenarios/SCENARIO-004-*.md` 至 `SCENARIO-007-*.md`、对应 Source/Evidence 和 `docs/decisions/RETIREMENT_REGISTER.md`。
